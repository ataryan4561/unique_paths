...
// ==============================================================
`timescale 1ns/1ps
module unique_paths_AXILiteS_s_axi
#(parameter
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_ANS_DATA_0: begin
                    rdata <= int_ans[31:0];
                end
                ADDR_ANS_CTRL: begin
                    rdata[0] <= int_ans_ap_vld;
                end
            endcase
        end
    end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (ans_ap_vld)
            int_ans_ap_vld <= 1'b1;
        else if (ar_hs && raddr == ADDR_ANS_CTRL)
            int_ans_ap_vld <= 1'b0; // clear on read
    end
end
